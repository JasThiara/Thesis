...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item Uncertainties(risks) in financial portfolios, and sectors of markets(e.g .com bubble, housing bubble)\cite{JAPBIIM}
  \end{itemize}
...
The financial industry maintains their portfolio positions, seeking the best qualitative information on stocks.
There are uncertainties in market value of an asset.  The stock market is unpredictable; despite posing a risk, the stock market still provides an avenue to increase one's net worth and increase value in assets.  In portfolio management, one of the main investment objectives is to minimize risk.
%The Divarication ???? <--- What is divarication?  diversification?  I'm not sure. ------$\vert$ in parameter decisions ultimately decides if the regression capacity overts, underÞts, or Þts ideally.
